    ...
    <table class="table table-bordered">
        ...
        @foreach ($customers as $customer)
            <tr id="customer_id_{{ $customer->id }}">
                ...
                <td>
                    @if($customer->image)
                        <img src="{{url("storage/{$customer->image}")}}" alt="{{$customer->name}}" width="80">
                    @endif
                </td>
                <td>
                    ...
                    <form  action="{{route('customers.destroy', [$customer->id])}}" method="post" id="form-button">
                        @csrf
                        @method("DELETE")
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="custForm" action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="image" class="form-control-file @error('image') is-invalid @enderror"  name="image" onchange="validate()" onkeypress="validate()">
